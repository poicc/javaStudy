...
import com.poicc.netty.demo.domain.*;
import com.poicc.netty.demo.util.CacheUtil;
import com.poicc.netty.demo.util.FileUtil;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        switch (fileTransferProtocol.getTransferType()) {
            ...
            case 2 -> {
                ...
                FileBurstInstruct fileBurstInstruct = FileUtil.writeFile("D:\\dev\\high-concurrency\\1\\", fileBurstData);
